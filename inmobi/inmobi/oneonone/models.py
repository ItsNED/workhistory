...
class Content(devices_models.TimeStampedModel):
    ...
    owner = models.ForeignKey(App, on_delete=models.PROTECT, null=True, related_name="contents")
...
class Result(devices_models.TimeStampedModel):
    ...
    owner = models.ForeignKey(Content, on_delete=models.PROTECT, null=True, related_name="results")
